...
export class RoundService {
  ...
  public async proceedToNextRound(agreementAddress: string): Promise<any> {
    ...
    try {
      ...
      // const phi =
      //   '';
      // const decryptedArrayString = await this.decryptArray(result, phi, n);

      // console.log(decryptedArrayString);
